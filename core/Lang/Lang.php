...
use Fiesta\Core\Translator\XMLUtilities;
...
class Lang {
	const LANG_TRANSLATION_ASSISTANCE = 0;
	/** 
	 ...
	 */
	private static $_locale_path = '../app/Local/'; // Always include trailing slash.
    ...
    private static function loadDictionary($language)
    {
    	...
    	//echo "<br/> Attempt to load [".$language."] dictionary";
    	 ...
    	 if (file_exists(Lang::$_locale_path."/".Res::session("ArFramework_lang")."/core.xml"))
    	 {	
    	 	Lang::$_dictionary=XMLUtilities::xmlfile_to_associative_array(Lang::$_locale_path."/".Res::session("ArFramework_lang")."/core.xml","UTF-8","language_translation/translations/translation","key");
    	 	//echo " ...ok!";
    ...
    public static function printTranslationAssistance()
    {
    	...
    	{
    		echo "Translation assistance for language ".Res::session("ArFramework_lang").
    		". <br/>(You can set this assistant OFF by setting the constant LANG_TRANSLATION_ASSISTANCE to false in the 'config.php' file)".
    		". <br/>Add the following elements to the locale/".Res::session("ArFramework_lang")."/core.xml file (or to the relevant subdictionary) :<br/>";
