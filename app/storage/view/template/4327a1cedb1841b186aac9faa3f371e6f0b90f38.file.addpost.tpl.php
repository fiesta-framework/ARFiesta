<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-12-31 16:46:08
         compiled from "..\app\themes\ARframework\modules\page\addpost.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162556854dc0a72b31-07563027%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4327a1cedb1841b186aac9faa3f371e6f0b90f38' => 
    array (
  ...
  'nocache_hash' => '162556854dc0a72b31-07563027',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_56854dc1308611_41659124',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56854dc1308611_41659124')) {function content_56854dc1308611_41659124($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
...
$_tmp25=ob_get_clean();?><?php echo Libs::css($_tmp24."app/themes/".$_tmp25."/assets/medias/js/dropZone/downloads/css/dropzone",false);?>
	...
	<?php ob_start();
echo Config::get('app.base_url');
$_tmp26=ob_get_clean();?><?php echo Libs::css($_tmp26."app/modules/page/Resources/public/css/addpost",false);?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['value']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['terms']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
													<li>
														<input type="checkbox" name="terms" value="<?php echo $_smarty_tpl->tpl_vars['terms']->value[$_smarty_tpl->getVariable('smarty')->value['section']['value']['index']]['term_id'];?>
">
														<label for="flat-checkbox-1" style="font-weight: 500;"><?php echo utf8_decode($_smarty_tpl->tpl_vars['terms']->value[$_smarty_tpl->getVariable('smarty')->value['section']['value']['index']]['name']);?>
</label>
													</li>
													<?php endfor; endif; ?>
												</ul>
...
echo Config::get('themes.name');
$_tmp28=ob_get_clean();?><?php echo Libs::js($_tmp27."app/themes/".$_tmp28."/assets/medias/js/preloader.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp29=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp30=ob_get_clean();?><?php echo Libs::js($_tmp29."app/themes/".$_tmp30."/assets/medias/js/bootstrap.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp31=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp32=ob_get_clean();?><?php echo Libs::js($_tmp31."app/themes/".$_tmp32."/assets/medias/js/flexgrid/js/flexigrid.pack.js",false);?>
...
echo Config::get('themes.name');
$_tmp34=ob_get_clean();?><?php echo Libs::js($_tmp33."app/themes/".$_tmp34."/assets/medias/js/app.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp35=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp36=ob_get_clean();?><?php echo Libs::js($_tmp35."app/themes/".$_tmp36."/assets/medias/js/load.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp37=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp38=ob_get_clean();?><?php echo Libs::js($_tmp37."app/themes/".$_tmp38."/assets/medias/js/main.js",false);?>
...
echo Config::get('themes.name');
$_tmp40=ob_get_clean();?><?php echo Libs::js($_tmp39."app/themes/".$_tmp40."/assets/medias/js/button/ladda/spin.min.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp41=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp42=ob_get_clean();?><?php echo Libs::js($_tmp41."app/themes/".$_tmp42."/assets/medias/js/button/ladda/ladda.min.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp43=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp44=ob_get_clean();?><?php echo Libs::js($_tmp43."app/themes/".$_tmp44."/assets/medias/js/button/progressbutton.jquery.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp45=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp46=ob_get_clean();?><?php echo Libs::js($_tmp45."app/themes/".$_tmp46."/assets/medias/js/iCheck/jquery.icheck.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp47=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp48=ob_get_clean();?><?php echo Libs::js($_tmp47."app/themes/".$_tmp48."/assets/medias/js/timepicker/bootstrap-timepicker.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp49=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp50=ob_get_clean();?><?php echo Libs::js($_tmp49."app/themes/".$_tmp50."/assets/medias/js/datepicker/bootstrap-datepicker.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp51=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp52=ob_get_clean();?><?php echo Libs::js($_tmp51."app/themes/".$_tmp52."/assets/medias/js/datepicker/clockface.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp53=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp54=ob_get_clean();?><?php echo Libs::js($_tmp53."app/themes/".$_tmp54."/assets/medias/js/datepicker/bootstrap-datetimepicker.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp55=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp56=ob_get_clean();?><?php echo Libs::js($_tmp55."app/themes/".$_tmp56."/assets/medias/js/tag/jquery.tagsinput.js",false);?>
	
	<?php ob_start();
echo Config::get('app.base_url');
$_tmp57=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp58=ob_get_clean();?><?php echo Libs::js($_tmp57."app/themes/".$_tmp58."/assets/medias/js/dropZone/lib/dropzone.js",false);?>

	<?php ob_start();
echo Config::get('app.base_url');
$_tmp59=ob_get_clean();?><?php echo Libs::js($_tmp59."app/modules/page/Resources/public/js/addpost.js",false);?>
