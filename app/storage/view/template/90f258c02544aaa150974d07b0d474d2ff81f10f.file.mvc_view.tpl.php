<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-12-09 02:36:25
         compiled from "..\app\themes\ARframework\Back-end\modules\backend\mvc_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1689556678599acb005-22989523%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90f258c02544aaa150974d07b0d474d2ff81f10f' => 
    array (
      0 => '..\\app\\themes\\ARframework\\Back-end\\modules\\backend\\mvc_view.tpl',
      1 => 1449624951,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1689556678599acb005-22989523',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5667859a0a1831_67351863',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5667859a0a1831_67351863')) {function content_5667859a0a1831_67351863($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
...
echo Config::get('themes.name');
$_tmp13=ob_get_clean();?><?php echo Libs::css($_tmp12."app/themes/".$_tmp13."/Back-end/assets/medias/js/tree/jquery.treeview",false);?>
...
echo Config::get('themes.name');
$_tmp15=ob_get_clean();?><?php echo Libs::js($_tmp14."app/themes/".$_tmp15."/Back-end/assets/medias/js/preloader.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp16=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp17=ob_get_clean();?><?php echo Libs::js($_tmp16."app/themes/".$_tmp17."/Back-end/assets/medias/js/bootstrap.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp18=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp19=ob_get_clean();?><?php echo Libs::js($_tmp18."app/themes/".$_tmp19."/Back-end/assets/medias/js/flexgrid/js/flexigrid.js",false);?>
...
echo Config::get('themes.name');
$_tmp21=ob_get_clean();?><?php echo Libs::js($_tmp20."app/themes/".$_tmp21."/Back-end/assets/medias/js/app.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp22=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp23=ob_get_clean();?><?php echo Libs::js($_tmp22."app/themes/".$_tmp23."/Back-end/assets/medias/js/load.js",false);?>

    <?php ob_start();
echo Config::get('app.base_url');
$_tmp24=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp25=ob_get_clean();?><?php echo Libs::js($_tmp24."app/themes/".$_tmp25."/Back-end/assets/medias/js/main.js",false);?>
...
echo Config::get('themes.name');
$_tmp27=ob_get_clean();?><?php echo Libs::js($_tmp26."app/themes/".$_tmp27."/Back-end/assets/medias/js/tree/lib/jquery.cookie.js",false);?>

<?php ob_start();
echo Config::get('app.base_url');
$_tmp28=ob_get_clean();?><?php ob_start();
echo Config::get('themes.name');
$_tmp29=ob_get_clean();?><?php echo Libs::js($_tmp28."app/themes/".$_tmp29."/Back-end/assets/medias/js/tree/jquery.treeview.js",false);?>
